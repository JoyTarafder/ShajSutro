              ...
              <div key={item.href} className="space-y-0.5">
                ...
                {item.href === "/admin/jobs" && isJobsSection && (
                  <Link
                    ...
                    className={`relative flex items-center gap-3 pl-[46px] pr-3 py-2 rounded-xl text-[13px] font-semibold transition-all duration-200 ${
                      pathname === "/admin/applications" ||
                      pathname.startsWith("/admin/applications/")
        ...
        {admin && (
          <div className="mt-3 flex items-center gap-3 px-3 py-3 rounded-xl bg-white/[0.04] border border-white/[0.07]">
            ...
            <div className="min-w-0">
              <p className="text-zinc-200 text-xs font-semibold truncate leading-none">
                {admin.name}
              </p>
