        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-end justify-between mb-14">
            <div>
              ...
              <p className="section-subtitle">Fresh styles added to the collection</p>
            </div>
            <Link
              href="/shop?badge=New"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
            {[
              ...
              <div key={item.title} className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-charcoal-900">{item.title}</h3>
                  <p className="text-xs text-charcoal-400 mt-0.5 font-light">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
